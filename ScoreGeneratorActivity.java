...
public class ScoreGeneratorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("team_selection").child("48");


        Users = FirebaseDatabase.getInstance().getReference().child("Users");
        datab = FirebaseDatabase.getInstance().getReference().child("data");
        sub = FirebaseDatabase.getInstance().getReference().child("MainTeamScore").child("48");
