package cricketworldcup.worldcup.AdminPanel.TeamParticipantScore;
...
import cricketworldcup.worldcup.AdminPanel.QuizParticipantScore.PscoreData;
...
public class TeamParticipantScoreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_team_participant_score);
    ...
    private void CreateData() {
        databaseReference = FirebaseDatabase.getInstance().getReference().child("MainTeamScore").child(matchno);
    ...
    public void createExcelSheet() {
        if (isStoragePermissionGranted()) {
            ...
            String csvFile = "TeamScoreDetails.xls";
    ...
    public class jsonTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Toast.makeText(TeamParticipantScoreActivity.this, "After 2 minutes You can Download the file", Toast.LENGTH_SHORT).show();
        }
