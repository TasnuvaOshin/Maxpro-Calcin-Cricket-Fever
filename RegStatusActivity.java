...
public class RegStatusActivity extends AppCompatActivity {
    ...
    private void FilterOperationSingleValueDsm(String gm_value) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    username = String.valueOf(ds.child("username").getValue());
                    userphoneno = String.valueOf(ds.child("userphoneno").getValue());
                    AllThisInfoSingleFilterDsm(userdsmcode, username, userphoneno, value);
    ...
    private void AllThisInfoSingleFilterDsm(final String userdsmcode, String username, String userphoneno, final String value) {
        final String dsm = userdsmcode;
        final String name = username;
        final String phone = userphoneno;
        datab.orderByChild("G").equalTo(dsm).addListenerForSingleValueEvent(new ValueEventListener() {
    ...
    private void FilterOperationSingleValueRsm(String gm_value) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    username = String.valueOf(ds.child("username").getValue());
                    userphoneno = String.valueOf(ds.child("userphoneno").getValue());
                    AllThisInfoSingleFilterRsm(userdsmcode, username, userphoneno, value);
    ...
    private void AllThisInfoSingleFilterRsm(final String userdsmcode, String username, String userphoneno, final String value) {
        Toast.makeText(this, "Its Come to All Data List", Toast.LENGTH_SHORT).show();
        final String dsm = userdsmcode;
        final String name = username;
        final String phone = userphoneno;
        ...
        dsm.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(i > j){
                    ...
                    dsm_pick = String.valueOf(adapterView.getItemAtPosition(i));
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                   ...
                   if(i >j){
                      ...
                      if(rsm_pick.equals("MR. A.B.M. AHSANUL HOQUE")){
                       ...
                       if(rsm_pick.equals("MR. MD. TARIQUL ISLAM")){
                           ShowDsmSpinner(R.array.rsm17);
                       ...
                       if(rsm_pick.equals("MR. MD. ROBIUL OUAL")){
                           ...
                           ShowDsmSpinner(R.array.rsm27);

                       } if(rsm_pick.equals("MR. MD. MOHIUDDIN ZELANE")){

                           ShowDsmSpinner(R.array.rsm1);


                       } if(rsm_pick.equals("MR. MD. NIZAM UDDIN")){
                       ...
                       } if(rsm_pick.equals("MR. FARUQUE HOSSAIN BHUIYAN")){
                           ShowDsmSpinner(R.array.rsm11);


                       } if(rsm_pick.equals("MR. A.K. M. MAHFUZUR RAHMAN")){

                           ShowDsmSpinner(R.array.rsm2);

                       } if(rsm_pick.equals("MR. MD. AZIZUR RAHMAN")){

                           ShowDsmSpinner(R.array.rsm9);

                       } if(rsm_pick.equals("MR. MD. AZHARUL ISLAM KHAN")){
                           ShowDsmSpinner(R.array.rsm22);

                       } if(rsm_pick.equals("MR. MONJURUL AZIZ")){

                           ShowDsmSpinner(R.array.rsm19);

                       } if(rsm_pick.equals("MR. MD. KAMRUZZAMAN")){

                           ShowDsmSpinner(R.array.rsm16);

                       } if(rsm_pick.equals("MR. MD. AMINUR RAHMAN")){
                           ShowDsmSpinner(R.array.rsm26);

                       } if(rsm_pick.equals("MR. MD. ABDULLAH AL MAMUN")){
                           ShowDsmSpinner(R.array.rsm20);


                       } if(rsm_pick.equals("MR. MD. SIDDIQUR RAHMAN")){
                           ShowDsmSpinner(R.array.rsm23);


                       } if(rsm_pick.equals("MR. H. M. MONIRUZZAMAN")){

                           ShowDsmSpinner(R.array.rsm18);

                       } if(rsm_pick.equals("MR. MD. SHAFIQUL ISLAM")){
                           ShowDsmSpinner(R.array.rsm12);

                       } if(rsm_pick.equals("MR. KAZI BENOZIR AHMED")){
                           ShowDsmSpinner(R.array.rsm25);


                       } if(rsm_pick.equals("MR. MD. SHAKHWAT HOSSAIN")){
                       ...
                       } if(rsm_pick.equals("MR. SUJIT KUMAR BASAK")){
                           ShowDsmSpinner(R.array.rsm21);

                       } if(rsm_pick.equals("MR. MD. NASIR UDDIN")){

                           ShowDsmSpinner(R.array.rsm4);

                       } if(rsm_pick.equals("MR. MD. ABU YOUSUF RANA")){
...
//                }
    ...
    public void DownLoadShortedData(View view) {
        ...
        if (gm_pick.equals("no") && !rsm_pick.equals("no") && dsm_pick.equals("no")) {
            list.clear();
            Toast.makeText(this, "RSM Filter Applying", Toast.LENGTH_SHORT).show();
            FilterOperationSingleValueRsm(rsm_pick);

        }

        if (gm_pick.equals("no") && rsm_pick.equals("no") && !dsm_pick.equals("no")){
            list.clear();
            Toast.makeText(this, "DSM Filter Applying", Toast.LENGTH_SHORT).show();
            FilterOperationSingleValueDsm(dsm_pick);

        }
        if (!gm_pick.equals("no") && !rsm_pick.equals("no") && dsm_pick.equals("no")){
            list.clear();
            Toast.makeText(this, "Sm & Rsm   Filter Applying", Toast.LENGTH_SHORT).show();
            FilterOperationDoublesmrsm(gm_pick,rsm_pick);
    ...
    private void FilterOperationDoublesmrsm(String gm_value,String rsmvalue) {

        final String valuegm = gm_value;
        final  String valuersm = rsmvalue;
        databaseReference.addValueEventListener(new ValueEventListener() {
            @SuppressLint("SetTextI18n")
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    username = String.valueOf(ds.child("username").getValue());
                    userphoneno = String.valueOf(ds.child("userphoneno").getValue());
                    AllThisInfodoubleFilterRsmSm(userdsmcode, username, userphoneno, valuegm,valuersm);
    ...
    private void  AllThisInfodoubleFilterRsmSm(final String userdsmcode, String username, String userphoneno, final String valuegm,final String valuersm) {
        Toast.makeText(this, "Its Come to All Data List", Toast.LENGTH_SHORT).show();
        final String dsm = userdsmcode;
        final String name = username;
        final String phone = userphoneno;
        datab.orderByChild("G").equalTo(dsm).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    rfid = String.valueOf(ds.child("F").getValue());
                    region = String.valueOf(ds.child("H").getValue());
                    if (smname.equals(valuegm) && rsmname.equals(valuersm)) {
                        listSingle.add(new all_filter_model_single(dsm, name, phone, dsmname, smname, smffc, rsmname, rsmffc, rfid, userdsmcode, region));
                    }
                }
